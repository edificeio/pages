...
/***/ (function(module, exports, __webpack_require__) {
	...
	var entcore_2 = __webpack_require__(1);
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	                        ...
	                        this.loading = true;
	                        return [4 /*yield*/, axios_1.default.get('/pages/list/all')];
	                    case 1:
	                        response = _a.sent();
	                        this.loading = false;
	        ...
	        navigation: {
	            ...
	            controller: {
	                init: function () {
	                    ...
	                    this.links = entcore_2._.map(this.snipletResource.pages.all, function (page) {
	                    ...
	                    this.links = entcore_2._.reject(this.links, function (l) { return l.published === false; });
	                    entcore_1.model.one('refresh-nav', function () { return _this.init(); });
	                    this.$apply('links');
	                },
	                initSource: function () {
	                    entcore_1.Behaviours.applicationsBehaviours.pages.loadResources(function (resources) {
